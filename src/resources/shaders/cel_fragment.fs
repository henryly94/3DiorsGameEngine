...
void main()
{
    vec3 e = normalize(mvVertexPos-eyePos);
    ...
    else
    {
        ...
        vec4 realColor = baseColour * totalLight;
        realColor.r = float(int(realColor.r * 256) - (int(realColor.r * 256) % 16)) / 256;
        realColor.g = float(int(realColor.g * 256) - (int(realColor.g * 256) % 16)) / 256;
        realColor.b = float(int(realColor.b * 256) - (int(realColor.b * 256) % 16)) / 256;
        fragColor = realColor;
    }
}